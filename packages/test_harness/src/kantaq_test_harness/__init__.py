...
if TYPE_CHECKING:
    ...
    from kantaq_test_harness.builders import (
        ...
        build_milestone,
        build_project,
        build_skill_container,
        build_skill_mapping,
        build_ticket,
        build_ticket_milestone,
...
_LAZY: dict[str, str] = {
    ...
    "Milestone": "kantaq_test_harness.models:Milestone",
    "PrivacyClass": "kantaq_test_harness.models:PrivacyClass",
    "Project": "kantaq_test_harness.models:Project",
    "SkillContainer": "kantaq_test_harness.models:SkillContainer",
    "SkillMapping": "kantaq_test_harness.models:SkillMapping",
    "Ticket": "kantaq_test_harness.models:Ticket",
    "TicketMilestone": "kantaq_test_harness.models:TicketMilestone",
    ...
    "build_milestone": "kantaq_test_harness.builders:build_milestone",
    "build_project": "kantaq_test_harness.builders:build_project",
    "build_skill_container": "kantaq_test_harness.builders:build_skill_container",
    "build_skill_mapping": "kantaq_test_harness.builders:build_skill_mapping",
    "build_ticket": "kantaq_test_harness.builders:build_ticket",
    "build_ticket_milestone": "kantaq_test_harness.builders:build_ticket_milestone",
